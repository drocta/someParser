...
This is some parser. Or, rather, right now all it is is a tokenizer/lexer . But it will probably have a parser also at some point. My intent is to use it for another thing later. (it is a sekret to everyone).
